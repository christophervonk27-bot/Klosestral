...
var $$Leistungen = createComponent(($$result, $$props, $$slots) => {
	...
	return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {
		...
		"showArrow": true,
		"data-astro-cid-iustjyzp": true
	})}</div></div></div></section><!-- Kontakt --><section id="kontakt" data-astro-cid-iustjyzp><div class="wrap kontakt-box" data-astro-cid-iustjyzp><div class="kontakt-text" data-astro-cid-iustjyzp><p class="eyebrow" data-astro-cid-iustjyzp>Bereit?</p><h2 data-astro-cid-iustjyzp>Reden wir über Ihr Projekt.</h2><p data-astro-cid-iustjyzp>Kostenloses Erstgespräch. Ich sage Ihnen ehrlich, ob und wie Zoho für Sie Sinn macht. Kein Verkaufspitch, kein Blendeffekt. Nur eine echte Einschätzung.</p></div><div class="kontakt-actions" data-astro-cid-iustjyzp><a href="mailto:christopher@kloseup.eu" class="btn" data-astro-cid-iustjyzp><span class="btn-text" data-astro-cid-iustjyzp>Per Mail</span><span class="btn-arrow" aria-hidden="true" data-astro-cid-iustjyzp>→</span></a><a href="https://wa.me/436603612354" class="btn" data-astro-cid-iustjyzp><span class="btn-text" data-astro-cid-iustjyzp>Per WhatsApp</span><span class="btn-arrow" aria-hidden="true" data-astro-cid-iustjyzp>→</span></a></div></div></section></main>${renderComponent($$result2, "Footer", $$Footer, { "data-astro-cid-iustjyzp": true })}` })}`;
