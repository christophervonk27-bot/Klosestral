...
var $$Header = createComponent(($$result, $$props, $$slots) => {
	...
	})}<ul class="nav-links" id="navLinks" data-astro-cid-nen7h5rs><li data-astro-cid-nen7h5rs><a${addAttribute(`${baseUrl}`, "href")} data-astro-cid-nen7h5rs>Startseite</a></li><li data-astro-cid-nen7h5rs><a${addAttribute(`${baseUrl}ueber-mich`, "href")} data-astro-cid-nen7h5rs>Über mich</a></li><li data-astro-cid-nen7h5rs><a${addAttribute(`${baseUrl}leistungen`, "href")} data-astro-cid-nen7h5rs>Leistungen</a></li><li data-astro-cid-nen7h5rs><a${addAttribute(`${baseUrl}kontakt`, "href")} data-astro-cid-nen7h5rs>Kontakt</a></li></ul><a${addAttribute(`${baseUrl}kontakt`, "href")} class="status-pill" aria-label="Verfügbar für Projekte – zur Kontaktseite" data-astro-cid-nen7h5rs><span class="status-dot" aria-hidden="true" data-astro-cid-nen7h5rs></span>Verfügbar für Projekte</a><button class="nav-toggle" aria-label="Menü öffnen" aria-expanded="false" id="navToggle" data-astro-cid-nen7h5rs><span data-astro-cid-nen7h5rs></span></button></div></header>${renderScript($$result, "/home/runner/work/Klosestral/Klosestral/src/components/Header.astro?astro&type=script&index=0&lang.ts")}`;
